              ...
              return (
                <div
                  ...
                  className={[
                    ...
                    checked
                      ? "border-orange-400 bg-gradient-to-br from-orange-50 via-white to-amber-50 shadow-[2px_2px_0_rgba(249,115,22,0.3)]"
                ...
                >
                  ...
                  <span className={[
                    ...
                    checked ? "bg-orange-500" : "bg-amber-500",
                  ].join(" ")} />
                  ...
                  <div className="flex items-start justify-between gap-2 pr-6">
                    ...
                    <span
                      className={[
                        ...
                        color === "emerald"
                          ? "border-orange-400 bg-gradient-to-b from-orange-400 to-orange-600 text-white shadow-[0_0_8px_rgba(249,115,22,0.4),inset_0_-1px_0_rgba(0,0,0,0.2)]"
                          : color === "amber"
                          ...
                          : "border-amber-400 bg-gradient-to-b from-amber-400 to-amber-600 text-white shadow-[0_0_8px_rgba(245,158,11,0.4),inset_0_-1px_0_rgba(0,0,0,0.2)]",
                      ].join(" ")}
                    >
                  ...
                  <div className="mt-2.5 flex flex-wrap gap-2">
                    {!checked ? (
                      ...
                      <button
                        ...
                        className="inline-flex h-8 items-center gap-1 rounded-lg border-2 border-amber-400 bg-gradient-to-b from-amber-400 to-amber-600 px-3 font-mono text-[11px] font-extrabold uppercase tracking-widest text-white shadow-[inset_0_-2px_0_rgba(0,0,0,0.25),2px_2px_0_rgba(245,158,11,0.35)] transition-all hover:from-amber-300 hover:to-amber-500"
                      >
